...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Our Office",
      content: "123 Marketing Street, Suite 100",
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.description}>
            Have questions or need assistance? Our team is here to help you with all your mobile marketing needs.
          </p>
        </div>
            ...
            <div className={styles.mapSection}>
              ...
              <div className={styles.mapContainer}>
                <div className={styles.mapPlaceholder}>
                  ...
                  <p>Interactive Map</p>
                  <p className={styles.mapAddress}>123 Marketing Street, Suite 100, San Francisco, CA 94107</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className={styles.supportCard}>
                ...
                <div className={styles.supportContact}>
                  <p className={styles.supportPhone}>
                    <FaPhone className={styles.supportIcon} /> +1 (555) 123-4567
                  </p>
